...
const styles = StyleSheet.create({
  ...
  splitWeekendsLabel: { ...t.label, color: '#f0f0f0', letterSpacing: 1.5, fontSize: 15, lineHeight: 17 },
  splitWeekendsToggle: {
    borderWidth: 1,
    borderColor: '#333333',
    paddingHorizontal: 10,
  ...
  splitWeekendsToggleText: { ...t.label, color: '#f0f0f0', fontSize: 15, letterSpacing: 1.5, lineHeight: 17 },
  prefLabel: {
  ...
  chipText: { fontFamily: fonts.mono.regular, fontSize: 15, lineHeight: 17, letterSpacing: 1, textTransform: 'uppercase' as const },
