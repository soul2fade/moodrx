...
>(function AlertDialogContent({ className, size, ...props }, ref) {
  ...
  return (
    <UIAccessibleAlertDialog.Content
      pointerEvents="auto"
      ref={ref}
      initial={isNative ? { scale: 1, opacity: 1 } : { scale: 0.9, opacity: 0 }}
      animate={isNative ? { scale: 1, opacity: 1 } : { scale: 1, opacity: 1 }}
      exit={isNative ? { scale: 1, opacity: 1 } : { scale: 0.9, opacity: 0 }}
      transition={
        isNative
          ? undefined
          : {
...
>(function AlertDialogBackdrop({ className, ...props }, ref) {
  ...
  return (
    <UIAccessibleAlertDialog.Backdrop
      ref={ref}
      initial={isNative ? { opacity: 0.5 } : { opacity: 0 }}
      animate={isNative ? { opacity: 0.5 } : { opacity: 0.5 }}
      exit={isNative ? { opacity: 0.5 } : { opacity: 0 }}
      transition={
        isNative
          ? undefined
          : {
