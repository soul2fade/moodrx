...
const styles = StyleSheet.create({
  ...
  subtext: { ...t.bodyMuted, fontSize: 16, lineHeight: 22 },
  hint: { ...t.softMuted, fontSize: 16, marginTop: 8, fontStyle: 'italic' },
  ...
  moodDesc: { ...t.bodySm, fontSize: 16, lineHeight: 17, marginTop: 2 },
  moodCode: { ...t.label, fontSize: 16, lineHeight: 17, letterSpacing: 1.5 },
  ...
  workoutPreviewLabel: { ...t.label, color: '#f0f0f0', letterSpacing: 1.5 },
  ...
  startButtonText: { ...t.button, letterSpacing: 2, fontSize: 16, lineHeight: 17 },
  skipButton: { paddingVertical: 16, alignItems: 'center', marginTop: 4 },
  skipText: { ...t.label, color: '#f0f0f0', letterSpacing: 1.5, lineHeight: 17 },
});
