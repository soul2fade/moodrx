...
const styles = StyleSheet.create({
  ...
  moodNote: { fontSize: 10, color: '#c8c8c8', fontStyle: 'italic', marginBottom: 10 },
  ...
  stepLabel: { fontSize: 11, color: '#c8c8c8', marginBottom: 12, letterSpacing: 1, textTransform: 'uppercase' },
