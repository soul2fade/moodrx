...
const styles = StyleSheet.create({
  ...
  focusBtnText: { ...t.label, color: '#cdcdcd', letterSpacing: 1.5, fontSize: 12, lineHeight: 17 },
  ...
  restLabel: { ...t.label, color: '#c5c5c5', letterSpacing: 4, fontSize: 13, marginBottom: 12 },
  ...
  restSubtext: { ...t.label, color: '#cdcdcd', letterSpacing: 2, fontSize: 12, lineHeight: 17, marginTop: 12 },
  ...
  activeTimerHint: { ...t.label, color: '#cdcdcd', letterSpacing: 2, fontSize: 12, lineHeight: 17, marginTop: 10 },
  ...
  sectionLabel: { ...t.label, color: '#c5c5c5', letterSpacing: 2, fontSize: 13, marginBottom: 14 },
  repHeaderRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14 },
  pbBadge: { fontFamily: fonts.mono.regular, fontSize: 13, color: '#cdcdcd', letterSpacing: 2 },
  ...
  repLabel: { ...t.label, color: '#c5c5c5', fontSize: 12, lineHeight: 17, letterSpacing: 2, marginTop: 2 },
  ...
  keepAwakeBtnText: { ...t.label, color: '#cdcdcd', fontSize: 13, letterSpacing: 2 },
