...
const styles = StyleSheet.create({
  ...
  moodNote: { fontSize: 10, color: '#ffffff', fontStyle: 'italic', marginBottom: 10 },
  ...
  stepLabel: { fontSize: 11, color: '#ffffff', marginBottom: 12, letterSpacing: 1, textTransform: 'uppercase' },
