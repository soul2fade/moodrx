...
const styles = StyleSheet.create({
  ...
  coachLabel: { fontSize: 16, color: '#f0f0f0', lineHeight: 17 },
  moodNote: { fontSize: 16, color: '#ffffff', fontStyle: 'italic', marginBottom: 10, lineHeight: 17 },
  ...
  coachName: { fontSize: 16, fontFamily: 'BarlowCondensed_700Bold', letterSpacing: 2, marginBottom: 10 },
  ...
  ctrlText: { fontSize: 16, color: '#f0f0f0' },
});
