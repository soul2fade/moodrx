...
const styles = StyleSheet.create({
  ...
  splitWeekendsLabel: { ...t.label, color: '#d8d8d8', letterSpacing: 2, fontSize: 12, lineHeight: 17 },
  splitWeekendsToggle: {
    borderWidth: 1,
    borderColor: '#333333',
    paddingHorizontal: 10,
  ...
  splitWeekendsToggleText: { ...t.label, color: '#cdcdcd', fontSize: 12, letterSpacing: 1.5, lineHeight: 17 },
  prefLabel: {
