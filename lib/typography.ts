...
export const type = {
  ...
  bodyMuted:   { fontFamily: fonts.primary.regular, fontSize: 15, color: '#c8c8c8', lineHeight: 23 },
  bodySm:      { fontFamily: fonts.primary.regular, fontSize: 14, color: '#c0c0c0', lineHeight: 21 },
  soft:        { fontFamily: fonts.primary.light,   fontSize: 15, color: '#c0c0c0', lineHeight: 23 },
  softMuted:   { fontFamily: fonts.primary.light,   fontSize: 13, color: '#a3a3a3', lineHeight: 20 },
