...
const streakLabelStyle: TextWidgetStyle = { fontSize: 15, fontWeight: 'bold', letterSpacing: 1.5, color: MUTED, marginTop: 2 };
const doneTodayStyleBase: TextWidgetStyle = { fontSize: 15, fontWeight: 'bold', letterSpacing: 1, marginTop: 10 };
const todayLabelStyle: TextWidgetStyle = { fontSize: 15, fontWeight: 'bold', letterSpacing: 1.5, color: MUTED };
const todaySmallStyle: TextWidgetStyle = { fontSize: 15, fontWeight: 'bold', letterSpacing: 1, color: MUTED, marginTop: 10 };
          ...
          {!snapshot.checkedInToday && snapshot.today && isMedium && (
            <FlexWidget style={{ flexDirection: 'column', width: 'match_parent', marginTop: 12 }}>
              ...
              <TextWidget
                ...
                style={{ fontSize: 15, color: FG, marginTop: 2 }}
                maxLines={1}
                truncate="END"
              />
              <TextWidget
