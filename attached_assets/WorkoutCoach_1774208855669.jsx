 ...
 *
 * Usage:
 *   <WorkoutCoach mood="anxious" />
 *   <WorkoutCoach mood="low" coachOverride="ron" />
 *
 * Props:
 *   mood: 'anxious' | 'low' | 'foggy' | 'restless' | 'stressed' | 'good'
 *   coachOverride: optional - force a specific coach instead of mood-matched
...
// ─── MOOD → COACH MAPPING ───────────────────────────────────────
const MOOD_COACH_MAP = {
  anxious:  'brick',   // Brick's innocent confusion disarms anxiety
  low:      'vera',    // Vera's campy confidence hypes you up
  foggy:    'ron',     // Ron's absurd verbosity cuts through fog
  restless: 'derek',   // Derek's vanity channels fidgety energy
  stressed: 'ricky',   // Ricky's chaos makes you laugh under pressure
  good:     'ron',     // Ron's swagger matches the vibe
};
...
// ─── PHRASE BANKS (5 per step per coach = 100 total) ────────────
const PHRASES = {
  vera: [
    [
      "Honey, these muscles don't build THEMSELVES",
      "The struggle is REAL and I am HERE for it",
      "Pain is just weakness leaving the body in HEELS",
      "This is SUFFERING, darling, but I'm FABULOUS",
      "My body is a TEMPLE and temples need MAINTENANCE",
    ],
    [
      "Ohhhh now we're TALKING",
      "These guns are WAKING UP, sweetie",
      "I can FEEL the magic happening",
      "The transformation has BEGUN, hunty",
      "My muscles are speaking and I am LISTENING",
    ],
    [
      "LOOK AT ME. I am STUNNING and STRONG",
      "These biceps don't LIE, baby",
      "I am a GODDESS in this body",
      "YESSS THIS is what POWER feels like",
      "My strength is UNDENIABLE and GORGEOUS",
    ],
    [
      "I am COMPLETE, I am WHOLE, I am MUSCULAR",
      "*flexes* THE WORK PAYS OFF, DARLING",
      "I have TRANSCENDED. I am GLOWING. I am RIPPED.",
      "Clarity? Try DEFINITION, honey",
      "HEAR ME ROAR, and LOOK AT THESE DELTOIDS",
    ],
  ],
  ron: [
    [
      "I'm in a glass case of emotion... and sweat",
      "My body is like a fine leather-bound book being read in a hurricane",
      "The pain is... actually quite poetic",
      "I immediately regret this decision",
      "This is NOT what the brochure promised",
    ],
    [
      "Stay classy, muscles",
      "I'm having a moment of clarity about my biceps",
      "Wait... am I kind of a big deal right now?",
      "Something is happening and it is GOOD",
      "My body just got a memo it did NOT expect",
    ],
    [
      "I'm KIND of a big deal",
      "People KNOW me. My body ESPECIALLY.",
      "I have many leather-bound books about my own strength",
      "I don't know how to put this but I'm pretty important",
      "This feeling? It's called being MAGNIFICENT",
    ],
    [
      "That escalated quickly... into enlightenment",
      "I'm a man of substance AND definition",
      "Milk was a bad choice but THIS was magnificent",
      "You stay classy. I stay POWERFUL.",
      "60% of the time I feel incredible EVERY time",
    ],
  ],
  brick: [
    [
      "I don't know what we're doing but I am SCARED",
      "Are we exercising? I love exercising! ...wait do I?",
      "My arms are confused",
      "Where am I? Oh right, working out. Cool cool cool.",
      "I think my legs are angry at me",
    ],
    [
      "Hey... I think something's happening!",
      "My body just did a thing and I LIKED it",
      "LOUD NOISES... but like, good ones?",
      "I can feel my blood! Is that normal?",
      "Wait I'm actually kind of good at this",
    ],
    [
      "I LOVE THIS",
      "I DON'T KNOW WHY I'M YELLING BUT IT FEELS RIGHT",
      "My muscles are having a PARTY",
      "I once ate a whole wheel of cheese. This is better.",
      "I feel like a RAINBOW made of BICEPS",
    ],
    [
      "I am very happy right now",
      "I think I just became a better person? Is that how this works?",
      "Everything is warm and tingly and WONDERFUL",
      "I would like to do this again please",
      "My body and my brain just became BEST FRIENDS",
    ],
  ],
  ricky: [
    [
      "If you ain't first you're last and RIGHT NOW I'm last",
      "I wanna go fast but my body wants to go HOME",
      "Shake and bake? More like ache and break",
      "Dear lord baby Jesus please let this end",
      "I'm too LEGIT for this kind of suffering",
    ],
    [
      "SHAKE... AND... BAKE",
      "We are GOING for it now",
      "I feel like a WINNER and winners don't quit",
      "My body just found second gear baby",
      "If you don't chew Big Red then... wait what was I saying",
    ],
    [
      "I'M ON FIRE. Not literally. FIGURATIVELY.",
      "SLINGSHOT ENGAGED",
      "I AM A MACHINE AND THIS MACHINE IS RUNNIN HOT",
      "Cal Naughton Jr WISHES he could feel this good",
      "THIS is what championship DNA feels like",
    ],
    [
      "I wanna be you when I grow up... wait I AM me",
      "That just happened. That JUST happened.",
      "Dear tiny baby Jesus, THANK YOU",
      "If you ain't first you're last. I am FIRST.",
      "I'm the BEST THERE IS, plain and simple",
    ],
  ],
  derek: [
    [
      "But why male models... I mean, why EXERCISE",
      "I can't turn left AND I can't do this",
      "This is NOT Blue Steel. This is Blue STRUGGLE.",
      "I feel like I'm taking crazy pills",
      "Is this a center for ANTS? Because I'm SWEATING like one",
    ],
    [
      "Wait... I think I just invented a new look. SWEAT STEEL.",
      "I'm PRETTY sure I'm getting prettier right now",
      "My body is like a RUNWAY and I just hit the turn",
      "Moisture is the essence of wetness and I am MOIST",
      "I feel a new look coming on...",
    ],
    [
      "MAGNUM. This is MAGNUM.",
      "I am RIDICULOUSLY good looking AND strong",
      "One look? ONE LOOK? I have MULTIPLE looks now",
      "This body was MADE for this. And also for modeling.",
      "Le Tigre WISHES it could feel this way",
    ],
    [
      "I think there's more to life than being really really ridiculously fit. But not much more.",
      "Ferrari. That's what this feeling is. FERRARI.",
      "I just Blue Steeled my own SOUL",
      "Moisture, strength, and INCREDIBLE bone structure",
      "I'm not just a model. I'm a MODEL ATHLETE.",
    ],
  ],
};

// ─── RANDOM PHRASE PICKER ───────────────────────────────────────
const getPhrase = (coachId, stepIndex) => {
...
const VeraFigure = ({ step, color, size = 200 }) => {
  const s = step;
  ...
  return (
    <Svg width={size} height={size * 1.3} viewBox="0 0 200 260">
      ...
      <G transform={`translate(100,${128 + by})`}>
        ...
        <Path d="M-8,-6 Q0,2 8,-6" fill="#1a1a1a" opacity="0.2" />
...
const RonFigure = ({ step, color, size = 200 }) => {
  const s = step;
...
const BrickFigure = ({ step, color, size = 200 }) => {
  const s = step;
...
const RickyFigure = ({ step, color, size = 200 }) => {
  const s = step;
...
const DerekFigure = ({ step, color, size = 200 }) => {
  const s = step;
...
// ─── FIGURE ROUTER ──────────────────────────────────────────────
const CoachFigure = ({ coachId, step, color, size }) => {
...
export default function WorkoutCoach({
  ...
  const coachId = coachOverride || MOOD_COACH_MAP[mood] || 'ron';
  const coach = COACHES[coachId];

  const [step, setStep] = useState(0);
  const [phrase, setPhrase] = useState(() => getPhrase(coachId, 0));
  const [selectedCoach, setSelectedCoach] = useState(coachId);

  // Update phrase when step or coach changes
  useEffect(() => {
  ...
  useEffect(() => {
    const newCoach = coachOverride || MOOD_COACH_MAP[mood] || 'ron';
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.coachRow}>
        {Object.values(COACHES).map((c) => (
          <TouchableOpacity
            ...
            style={[
              styles.coachBtn,
              selectedCoach === c.id && { borderColor: c.color, backgroundColor: c.color + '18' },
            ]}
            onPress={() => { setSelectedCoach(c.id); setStep(0); }}
          >
            <View style={[styles.coachDot, { backgroundColor: c.color }]} />
            <Text style={[styles.coachLabel, selectedCoach === c.id && { color: c.color }]}>
              {c.id}
            </Text>
          </TouchableOpacity>
        ))}
      ...
      <Text style={styles.moodNote}>
        mood-matched: {COACHES[MOOD_COACH_MAP[mood]]?.name?.toLowerCase()}
      </Text>

      {/* Figure */}
      <View style={styles.figureWrap}>
        <CoachFigure coachId={selectedCoach} step={step} color={activeCoach.color} size={180} />
      </View>
      ...
      <Text style={styles.coachName}>{`\u2014 ${activeCoach.name.toLowerCase()}`}</Text>

      {/* Step dots */}
      <View style={styles.dotRow}>
        {STEPS.map((st, i) => (
          <View key={st.key} style={[styles.dot, i === step && styles.dotActive]} />
        ))}
      </View>
      <Text style={styles.stepLabel}>
        {`step ${step + 1}: ${STEPS[step].label.toLowerCase()}`}
      </Text>
      ...
      {!autoPlay && (
        <View style={styles.controls}>
          <TouchableOpacity
            ...
            disabled={step === 0}
          >
            <Text style={[styles.ctrlText, step === 0 && { opacity: 0.3 }]}>prev</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[styles.ctrlBtn, { backgroundColor: activeCoach.color + '20', borderColor: activeCoach.color }]}
            onPress={advanceStep}
          >
            <Text style={[styles.ctrlText, { color: activeCoach.color }]}>
              {step < 3 ? 'next' : 'done'}
            </Text>
          </TouchableOpacity>
        </View>
