...
export const SUPPLEMENTS: Supplement[] = [
  ...
  },
  {
    ...
    sources: [
      "Mori et al. (2009). Improving effects of the mushroom Yamabushitake on mild cognitive impairment. Phytother Res.",
  ...
  },
  {
    ...
    science: "Phosphatidylserine is a phospholipid that forms a critical part of your cell membranes, especially in brain cells. Clinical trials show it improves memory, attention, and processing speed — and it's one of the only two supplements the FDA has granted a qualified health claim for cognitive function. Under stress, it also helps blunt excess cortisol, making it useful on both fronts. The form matters: soy-derived PS has the most human clinical data.",
    sources: [
      ...
      "Fahey et al. (1998). Blunting of the cortisol response to exercise by dehydroepiandrosterone. FDA Qualified Health Claim Docket.",
    ],
  },
  {
    name: 'Rhodiola',
  ...
  },
  {
    ...
    dose: '500-2000mg',
    moods: ['foggy', 'low'],
    science: "Tyrosine is the direct amino acid precursor to dopamine and norepinephrine. Under conditions of stress, sleep deprivation, or cognitive load, tyrosine gets depleted faster than you can replenish it from diet alone. Studies show it improves working memory, cognitive flexibility, and processing speed in depleted states. It works best when you actually need it — if your dopamine is already running fine, the effect is minimal.",
    sources: [
      "Jongkees et al. (2015). Effect of tyrosine supplementation on clinical and healthy populations under stress. J Psychiatr Res.",
  ...
  },
  {
    ...
    dose: '300-600mg',
    moods: ['foggy', 'good'],
    science: "Alpha-GPC is the most bioavailable form of choline — a precursor to acetylcholine, the neurotransmitter most associated with learning, memory, and attention. Most people don't get enough choline from diet alone. Clinical trials show Alpha-GPC improves attention, memory recall, and reaction time. It's one of the few cognitive supplements with genuine dose-response evidence in healthy adults, not just impaired populations.",
    sources: [
      "Parnetti et al. (2007). Cholinergic precursors in the treatment of cognitive impairment. Mech Ageing Dev.",
      "De Jesus Moreno Moreno (2003). Cognitive improvement in mild to moderate Alzheimer's dementia after treatment with alpha-glycerophosphocholine. Clin Ther.",
